...
public class MissingOrIncorrectArgumentException extends Exception {
	...
	public MissingOrIncorrectArgumentException () {
		this.message = Localization.get("missingOrIncorrectArgumentException");
//		this.message = "Missing or Incorrect Arguments. See /scs help.";//msg: missingOrIncorrectArgumentException
	}
